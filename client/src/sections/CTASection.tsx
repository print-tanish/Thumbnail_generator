...
export default function CTASection() {
  ...
  return (
    ...
    >
      <div>
        <motion.h1
          className="text-4xl md:text-[46px] md:leading-[3.75rem] font-semibold bg-gradient-to-r from-white to-pink-400 text-transparent bg-clip-text"
        ...
        >
          Join thousands of creators using Thumblify to create stunning thumbnails in seconds.
        </motion.p>
      </div>
